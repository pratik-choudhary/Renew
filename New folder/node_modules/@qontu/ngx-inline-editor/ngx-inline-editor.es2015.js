import { Component, ComponentFactoryResolver, EventEmitter, Injector, Input, NgModule, Output, ReflectiveInjector, Renderer, ViewChild, ViewContainerRef, forwardRef } from '@angular/core';
...
class InputBase {
    ...
    checkValue() {
        ...
        if (this.canTestRegex(this.config)) {
            if (!new RegExp(/** @type {?} */ (this.config.pattern)).test(value)) {
                errs.push({
                    type: "PATTERN_ERROR",
        ...
        if (this.canTestLength(this.config)) {
            ...
            const /** @type {?} */ length = this.isNumeric ? Number(value) : value.length;
...
class InlineEditorComponent {
    ...
    updateConfig(config, property, value) {
        if (this.config) {
            ...
            this.events.internal.onUpdateConfig.emit(Object.assign({}, config));
        }
    }
    /**
     * @param {?} event
